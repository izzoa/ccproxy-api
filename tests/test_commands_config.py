"""Tests for claude_code_proxy/commands/config.py module."""
...
from claude_code_proxy.commands.config import (
...
class TestGetConfigPathFromContext:
    ...
    def test_get_config_path_from_context_with_valid_context(self):
        ...
        with patch("claude_code_proxy.commands.config.get_current_context") as mock_ctx:
            mock_context = Mock()
...
class TestConfigListCommand:
    ...
    def test_config_list_success(self):
        ...
        with (
            patch(
                "claude_code_proxy.commands.config.get_settings",
                return_value=mock_settings,
            ),
            patch(
                "claude_code_proxy.commands.config.get_config_path_from_context",
                return_value=None,
            ),
        ):
    ...
    def test_config_init_yaml_format_no_yaml_module(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                patch("claude_code_proxy.commands.config.yaml", None, create=True),
            ):
                # Mock import error
                import builtins
...
class TestConfigSchemaCommand:
    ...
    def test_config_schema_default(self):
        ...
        with patch(
            "claude_code_proxy.commands.config.generate_schema_files",
    ...
    def test_config_schema_with_taplo(self):
        ...
        with (
            ...
            patch(
                "claude_code_proxy.commands.config.generate_taplo_config",
...
class TestConfigValidateCommand:
    ...
    def test_config_validate_success(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".toml", delete=False) as f:
            ...
            try:
                with patch(
                    "claude_code_proxy.commands.config.validate_config_with_schema",
                    return_value=True,
                ):
...
class TestGenerateTokenCommand:
    ...
    def test_generate_token_display_only(self):
        ...
        with patch(
            "claude_code_proxy.commands.config.secrets.token_urlsafe",
    ...
    def test_generate_token_save_new_file(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                patch(
                    "claude_code_proxy.utils.find_toml_config_file", return_value=None
                ),
            ):
                result = self.runner.invoke(
    ...
    def test_generate_token_save_existing_file_no_force(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                patch(
                    "claude_code_proxy.config.settings.Settings.load_config_file",
    ...
    def test_generate_token_save_auto_detect_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                patch(
                    "claude_code_proxy.utils.find_toml_config_file",
