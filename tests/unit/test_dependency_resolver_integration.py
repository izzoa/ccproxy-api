...
class TestDependencyResolverIntegration:
    ...
    def test_loader_with_satisfied_dependencies(self, mock_version, temp_plugin_with_deps):
    ...
    @patch("importlib.metadata.version")
    def test_loader_with_missing_dependencies(self, mock_version, temp_plugin_with_deps):
    ...
    @patch("importlib.metadata.version")
    @pytest.mark.asyncio
    async def test_registry_with_dependency_management(self, mock_version, temp_plugin_with_deps):
    ...
    @patch("importlib.metadata.version")
    @pytest.mark.asyncio
    async def test_registry_dependency_report(self, mock_version, temp_plugin_with_deps):
    ...
    @patch("importlib.metadata.version")
    @pytest.mark.asyncio
    async def test_registry_resolve_dependencies(self, mock_version, mock_run, temp_plugin_with_deps):
